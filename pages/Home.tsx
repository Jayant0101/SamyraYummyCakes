    ...
    <div className="flex flex-col min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-shadow text-center">
              ...
              <h3 className="font-serif text-2xl font-bold mb-3">Birthdays</h3>
              <p className="text-gray-600">From superheroes to princesses, we make every birthday magical with themed custom cakes.</p>
            </div>
            
            <div className="bg-white p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-shadow text-center transform md:-translate-y-4">
              <div className="w-16 h-16 bg-rose-100 rounded-full flex items-center justify-center mx-auto mb-6 text-rose-500">
                <Heart className="w-8 h-8" />
              </div>
              <h3 className="font-serif text-2xl font-bold mb-3">Weddings</h3>
              <p className="text-gray-600">Elegant multi-tier cakes that taste as good as they look. The perfect centerpiece for your big day.</p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-shadow text-center">
              ...
              <h3 className="font-serif text-2xl font-bold mb-3">Custom Designs</h3>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1 grid grid-cols-2 gap-4">
              <img src="https://images.unsplash.com/photo-1535141192574-5d4897c12636?auto=format&fit=crop&w=400&q=80" className="rounded-2xl shadow-lg mt-8" alt="Cake 1" />
              <img src="https://images.unsplash.com/photo-1558961363-fa8fdf82db35?auto=format&fit=crop&w=400&q=80" className="rounded-2xl shadow-lg" alt="Cake 2" />
              <img src="https://images.unsplash.com/photo-1621303837174-89787a7d4729?auto=format&fit=crop&w=400&q=80" className="rounded-2xl shadow-lg" alt="Cake 3" />
              <img src="https://images.unsplash.com/photo-1563729784474-d77dbb933a9e?auto=format&fit=crop&w=400&q=80" className="rounded-2xl shadow-lg -mt-8" alt="Cake 4" />
            </div>
      ...
      <section className="py-20 bg-amber-50">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="font-serif text-3xl font-bold mb-12">Sweet Words from Our Customers</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((t) => (
