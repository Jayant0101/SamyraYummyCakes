...
import { Menu, X, Cake, Sparkles, Package } from 'lucide-react';
        ...
        <div className="lg:hidden bg-white border-t border-gray-100">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <a
              ...
              rel="noreferrer"
              onClick={() => setIsOpen(false)}
              className="block text-center bg-green-500 text-white px-5 py-2 rounded-full text-sm font-bold mt-2"
            >
              WhatsApp Us
            </a>
          </div>
